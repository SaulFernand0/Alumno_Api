...
const readAlumno = async (req, res) => {
    try {
        const response = await pool.query('select a.idalumno, a.nombres, a.apellidos, a.direccion, a.telefono, a.idescuela, e.nom_escuela from alumno a, escuela e where a.idescuela = e.idescuela;');
